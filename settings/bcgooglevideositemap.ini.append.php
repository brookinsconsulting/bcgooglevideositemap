...
[BCGoogleVideoSitemapSettings]
# Define Subtree to create video sitemap from
SitemapRootNodeID=2
# Specify Video Sitemap XML file storage path
Filename=var/sitemapvideo.xml
# Relative to the eZ Publish website root directory
Path=
